...
# python main.py  --method DC  --dataset CIFAR10  --model ConvNet  --eval_mode my_eval  --ipc 1 --num_exp 1  --num_eval 2  --Iteration 3000
# python main.py  --method DC  --dataset CIFAR10  --model ConvNet  --eval_mode my_eval  --ipc 1 --num_exp 1  --num_eval 2  --Iteration 3000  --use_ModelPool
# python main.py  --method DC  --dataset CIFAR10  --model ConvNet  --eval_mode my_eval  --ipc 1 --num_exp 1  --num_eval 2  --Iteration 3000  --use_Dropout
python main.py  --method DC  --dataset CIFAR10  --model ConvNet  --eval_mode my_eval  --ipc 1 --num_exp 1  --num_eval 2  --Iteration 3000  --use_KD  --temperature 0.3  --alpha 0.5
