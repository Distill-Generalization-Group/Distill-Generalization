    ...
    if args.use_stored:
        if args.eval_model == "all":
            ...
            for index in range(len(eval_model_list)):
                ...
                tem_list = [0.0]
                #tem_list = [0.0, 0.05]
                # tem_list = [0.0, 0.05, 0.1, 0.3, 0.5, 0.7, 1.0, 1.5, 2.0, 3.0]
                ...
                for i in tqdm.tqdm(range(len(tem_list))):
                    ...
                    for _ in tqdm.tqdm(range(args.num_eval)):
                        ...
                        # image_syn_eval, label_syn_eval = copy.deepcopy(image_syn_eval.detach()), copy.deepcopy(label_syn_eval.detach()) # avoid any unaware modification
