python main.py  --method DC  --dataset MNIST  --model RandomChoose  --eval_mode my_eval  --ipc 1 --num_exp 1  --num_eval 2  --Iteration 10000
...
python main.py  --method DC  --dataset CIFAR10  --model ConvNet  --eval_mode my_eval  --ipc 1 --num_exp 1  --num_eval 2  --Iteration 5000
python main.py  --method DC  --dataset CIFAR10  --model RandomChoose  --eval_mode my_eval  --ipc 1 --num_exp 1  --num_eval 2  --Iteration 3000

python main.py  --method DC  --dataset CIFAR10  --model ConvNet  --eval_mode my_eval  --ipc 10 --num_exp 1  --num_eval 3  --Iteration 5000